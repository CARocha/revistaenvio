# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2018-03-20 21:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autornota', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Introducci\xf3n')),
                ('cambio', ckeditor.fields.RichTextField(blank=True, null=True)),
                ...
                ('nota', ckeditor.fields.RichTextField(blank=True, null=True)),
            ],
            options={
                'ordering': ['id'],
                'db_table': 'articulos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_en', models.CharField(blank=True, max_length=150, null=True, verbose_name='Nombre ingles')),
                ('nombre_es', models.CharField(blank=True, max_length=150, null=True, verbose_name='Nombre en espa\xf1ol')),
            ],
            options={
                'ordering': ('nombre',),
                'db_table': 'autores',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portada', sorl.thumbnail.fields.ImageField(blank=True, null=True, upload_to=revista.utils.get_file_path)),
                ('color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='revista.ColoresRevista')),
                ('ididioma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='revista.Idiomas', verbose_name='idioma')),
            ],
            options={
                'ordering': ('-numero', '-mes'),
                'db_table': 'revistas',
